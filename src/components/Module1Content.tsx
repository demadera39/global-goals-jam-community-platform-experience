  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-b pb-4">
        <h2 className="text-2xl font-bold text-foreground">Module 1: Understanding Global Goals Jam</h2>
      ...
      {/* Learning Outcomes */}
      <Card className="bg-pastel-sky border-primary/20">
        <div className="p-6">
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <div className="space-y-4">
            <Card className="p-4 border-l-4 border-primary">
              <h4 className="font-semibold text-primary/80">Amsterdam: Circular Fashion</h4>
            ...
            <Card className="p-4 border-l-4 border-sky-500">
              <h4 className="font-semibold text-sky-700">Nairobi: Clean Water Access</h4>
              <p className="text-sm text-muted-foreground mt-1">
            ...
            <Card className="p-4 border-l-4 border-violet-500">
              <h4 className="font-semibold text-violet-700">São Paulo: Urban Gardens</h4>
              <p className="text-sm text-muted-foreground mt-1">
        ...
        <section>
          ...
          <div className="bg-gradient-to-r from-pastel-green to-pastel-sky p-6 rounded-lg">
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-foreground">Think Global, Act Local</h4>
                <p className="text-sm text-muted-foreground mt-1">
                  Every community has unique challenges and assets. Jams help translate global goals into local action.
                </p>
              </div>
              <div>
                <h4 className="font-semibold text-foreground">Design for Systems Change</h4>
                <p className="text-sm text-muted-foreground mt-1">
                  We don't just solve symptoms – we identify leverage points for transformative change.
                </p>
              </div>
              <div>
                <h4 className="font-semibold text-foreground">Collaborate Across Boundaries</h4>
                <p className="text-sm text-muted-foreground mt-1">
                  Jams bring together diverse perspectives: citizens, experts, officials, and entrepreneurs.
                </p>
              </div>
              <div>
                <h4 className="font-semibold text-foreground">Prototype and Iterate</h4>
                <p className="text-sm text-muted-foreground mt-1">
        ...
        {/* Key Takeaways */}
        <Card className="bg-pastel-amber border-amber-200">
          <div className="p-6">
