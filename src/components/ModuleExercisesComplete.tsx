...
interface ModuleExercisesCompleteProps {
  moduleNumber: number;
  exercises: Exercise[];
...
export const ModuleExercisesComplete: React.FC<ModuleExercisesCompleteProps> = ({ 
  moduleNumber, 
  exercises,
  onExerciseComplete,
  ...
  const getExerciseDetails = (exercise: Exercise) => {
    // Enhanced exercise details for all modules
    const exerciseGuides: Record<string, any> = {
        ...
        resources: [
          {
            ...
            url: 'https://globalgoalsjam.org/stories',
      ...
      'partner-mapping': {
        ...
        resources: [
          ...
          },
          {
            ...
            url: 'https://globalgoalsjam.org/resources/partnership',
            description: 'How to approach potential partners effectively'
          },
          {
            title: 'Local SDG Networks',
            url: 'https://www.unglobalcompact.org/engage-locally',
        ...
        resources: [
          {
            ...
            url: 'https://www.thinking.net/Systems_Thinking/systems_thinking.html',
            description: 'Learn the basics of systems thinking and complexity'
          },
          {
            title: 'Iceberg Model',
            url: 'https://www.systemsinnovation.io/post/iceberg-model',
        ...
        resources: [
          {
            ...
            url: 'https://www.undp.org/sdg-accelerator/sdg-interlinkages',
      ...
      'document-strategy': {
        steps: [
          'Use the Open Design Principles worksheet to plan documentation',
          'List all outputs you want to capture (ideas, prototypes, processes)',
          'Assign documentation roles to team members',
          'Choose your primary sharing platform (website, GitHub, etc.)',
          'Select appropriate Creative Commons license',
          'Create templates for consistent documentation',
          'Plan your post-jam knowledge transfer activities'
        ],
        tips: [
          'Document throughout the jam, not just at the end',
          'Use multiple formats - photos, videos, written notes',
          'Make documentation someone\'s specific responsibility',
          'Consider accessibility - multiple languages, formats'
        ],
        resources: [
          {
            title: 'Creative Commons Licenses',
            url: 'https://creativecommons.org/choose/',
            description: 'Choose the right open license for your outputs'
          },
          {
            title: 'Documentation Best Practices',
            url: 'https://opensource.guide/best-practices/',
            description: 'How to document for maximum reuse and impact'
          }
        ],
        checkQuestion: 'What\'s your documentation strategy and who will be responsible?'
      },
      'knowledge-products': {
        steps: [
          'Complete the Knowledge Sharing Canvas',
          'Identify your target audiences for jam outputs',
          'Plan immediate outputs (within 1 week)',
          'Plan processed outputs (within 1 month)',
          'Choose dissemination channels for each audience',
          'Create a timeline for sharing activities',
          'Identify amplifiers who can help spread knowledge'
        ],
        tips: [
          'Different audiences need different formats',
          'Quick wins: share photos and key insights immediately',
          'Create both technical and accessible versions',
          'Use storytelling to make outputs engaging'
        ],
        resources: [
          {
            title: 'Knowledge Management Toolkit',
            url: 'https://www.km4dev.org/wiki/index.php/KM_Tools',
            description: 'Tools and methods for knowledge sharing'
          },
          {
            title: 'Impact Storytelling Guide',
            url: 'https://www.globalinnovation.fund/what-we-do/knowledge/storytelling/',
            description: 'How to tell compelling stories about your impact'
          }
        ],
        checkQuestion: 'What are your top 3 knowledge products and who are they for?'
      },

      // Module 4 Exercises
      'prepare-jamkit': {
        steps: [
          'Complete the Jamkit Preparation Checklist',
          'Inventory materials you already have',
          'Create a shopping list for missing items',
          'Identify digital alternatives for physical materials',
          'Test all technology and equipment',
          'Prepare backup plans for critical materials',
          'Create a setup timeline for jam day'
        ],
        tips: [
          'Do a dry run with all materials before the jam',
          'Have 20% more supplies than you think you need',
          'Create a materials station for easy access',
          'Label everything clearly'
        ],
        resources: [
          {
            title: 'Jamkit Shopping List',
            url: 'https://globalgoalsjam.org/toolkit/materials',
            description: 'Complete list with suppliers and alternatives'
          },
          {
            title: 'Digital Tools Collection',
            url: 'https://miro.com/templates/design-sprint/',
            description: 'Online alternatives to physical materials'
          }
        ],
        checkQuestion: 'What are your top 3 material priorities and backup plans?'
      },
      'select-methods': {
        steps: [
          'Review the Method Selection Guide',
          'Consider your challenge type and participant mix',
          'Select 2-3 methods for each sprint phase',
          'Prepare materials for each selected method',
          'Practice facilitating each method',
          'Create method cards for quick reference',
          'Plan transitions between methods'
        ],
        tips: [
          'Choose methods that build on each other',
          'Have backup methods ready',
          'Consider participant energy levels',
          'Mix analytical and creative methods'
        ],
        resources: [
          {
            title: 'Design Sprint Methods',
            url: 'https://www.gv.com/sprint/',
            description: 'Detailed guides for sprint methods'
          },
          {
            title: 'Facilitation Method Library',
            url: 'https://www.sessionlab.com/library',
            description: 'Searchable database of facilitation methods'
          }
        ],
        checkQuestion: 'Which methods will you use for each sprint and why?'
      },

      // Module 5 Exercises
      'facilitation-scenarios': {
        steps: [
          'Complete the Facilitation Plan template',
          'Identify your natural facilitation style',
          'Plan energy management throughout the jam',
          'Prepare responses for difficult situations',
          'Design inclusion strategies for all participants',
          'Coordinate with co-facilitators if applicable',
          'Practice key facilitation moments'
        ],
        tips: [
          'Know your strengths and when to lean on them',
          'Have a co-facilitator who complements your style',
        ...
        resources: [
          {
            ...
            url: 'https://www.storypikes.com/workshops/PDFs/Facilitators%20Guide%20to%20Participation.pdf',
            description: 'Comprehensive facilitation techniques'
          },
          {
            title: 'Liberating Structures',
            url: 'https://www.liberatingstructures.com/',
            description: 'Innovative facilitation methods for engagement'
          }
        ],
        checkQuestion: 'What\'s your plan for handling challenging facilitation moments?'
      },
      'engagement-toolkit': {
        steps: [
          'Review the Engagement Techniques Toolkit',
          'Select opening icebreakers appropriate for your group',
          'Choose energizers for different times of day',
          'Pick decision-making methods for your context',
          'Plan reflection and closing activities',
          'Create a minute-by-minute facilitation script',
          'Prepare all materials for engagement activities'
        ],
        tips: [
          'Match activities to your group\'s culture',
          'Have quiet and loud options',
          'Build in choice - let participants select sometimes',
          'End on a high note'
        ],
        resources: [
          {
            title: 'Energizer Database',
            url: 'https://www.funretrospectives.com/category/energizer/',
            description: 'Quick activities to boost energy'
          },
          {
            title: 'Icebreaker Collection',
            url: 'https://www.icebreakers.ws/',
            description: 'Hundreds of icebreaker activities'
          }
        ],
        checkQuestion: 'What are your go-to engagement techniques for different moments?'
      }
    };
